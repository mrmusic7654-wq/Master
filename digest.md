...
<details><summary>tail of gradle-test.log</summary>
...
370 actionable tasks: 172 executed, 198 from cache
```
...
Raw logs branch: `ci/diag-unit-tests` (fetch with
`git fetch origin ci/diag-unit-tests && git show FETCH_HEAD --stat`).
